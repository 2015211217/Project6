...
dir_test_result = "/Users/jiangxuanke/Desktop/ISSM/Test_result.csv"
...
csvFile = open("/Users/jiangxuanke/Desktop/issm2020-ai-challenge/TestResultMark.csv", "w")  # 创建csv文件
csvRead = pd.read_table(dir_test_result, "r")
writer = csv.writer(csvFile)
writer.writerow(["Id", "LABEL"])
list_ori = csvRead.values.tolist()
list = []
...
while(list):
    print(list[0], list[1])
    writer.writerow([list[0], list[1]])
    del(list[0])
    del(list[0])
# for row in csvRead.iteritems():
